...
#define SMOTA_PORT_BOOT_CONTROL_ADDR (SMOTA_FLASH_BASE_ADDR + SMOTA_BOOTLOADER_SIZE - SMOTA_FLASH_PAGE_SIZE)
#define SMOTA_PORT_BOOT_CONTROL_END  (SMOTA_FLASH_BASE_ADDR + SMOTA_BOOTLOADER_SIZE)
#define SMOTA_PORT_BOOT_STATE_EMPTY  0xFFFFFFFFU
